    ...
    <div class="container-fluid main-page">
        <div class="app-main">
            ...
            <div class="main-content">
                ...
                <form class="addPro" action="index.php?act=updtSp" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" id="name" placeholder="Nhập tên sản phẩm" value="<?=$name?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="price" id="price_sale" class="form-control" placeholder="Giá" value="<?=$price?>"> 
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Mô tả :</label>
                        <textarea class="form-control" name="description" rows="3" placeholder="Nhập 1 đoạn mô tả ngắn về sản phẩm" style="height: 78px;" ><?=$description?></textarea>
                    </div>
                    <div class="form-group">
                        <input type="submit" value="Sửa sản phẩm" name="updtSp" class="btn btn-primary">
